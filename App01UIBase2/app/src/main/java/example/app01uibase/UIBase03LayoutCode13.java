...
public class UIBase03LayoutCode13 extends AppCompatActivity {
    ...
    public void xmlOnClick(View v){
        RelativeLayout relativeLayout = (RelativeLayout) View.inflate(this, R.layout.new_message_module13, null);
